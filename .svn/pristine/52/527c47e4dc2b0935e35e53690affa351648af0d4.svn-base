...
@Controller
@RequestMapping(value = "/wh1")
public class WHAction1 {
	private JacksonUtil jacksonUtil = JacksonUtil.buildNormalBinder();
	private WHServer1 whServer;

	public WHServer1 getWhServer() {
		return whServer;
	}
	@Autowired
	public void setWhServer(WHServer1 whServer) {
	...
	@RequestMapping("/find")
	@ResponseBody
	public String find(@RequestParam("postData") String postData) {
...
//		String gzb = "维修车次";//导出sheet名和导出的文件名
	...
	@RequestMapping("/save")
	@ResponseBody
	public String save(@RequestParam("postData") String postData){
		String msg = whServer.save(postData);
		return msg;
	}
	@RequestMapping("/edit")
	@ResponseBody
	public String edit(@RequestParam("postData") String postData){
		String msg = whServer.edit(postData);
		return msg;
	}
	@RequestMapping("/del")
	@ResponseBody
	public String del(@RequestParam("postData") String postData){
