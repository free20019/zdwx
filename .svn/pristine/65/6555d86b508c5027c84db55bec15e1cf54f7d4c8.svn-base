...
public class WXAction1 {
	...
	public String findqkbexcle(HttpServletRequest request,
		...
		String a[] = {"车牌号码","报修日期","维修日期","故障类型","故障类型","维修地点","维修方式"
				,"维修内容","维修费用","维修审核","审核人","审核时间","客户满意度",
				"所属公司","报修地点","终端类型","报修人员","紧急程序","维修地点","配件使用情况","费用收费方式","是否修复","是否转单","转单状态"};//导出列明
		String b[] = {"VEHI_NO","SXSJ","WXSJ","RM_MALFUNCTION1","RM_MALFUNCTION","RA_ADDR","RT_TYPE",
				"RC_CONTENT","RR_COST","SHJG","SHRY_NAME","SHSJ","TCSS",
				"COMP_NAME","REPORT_ADDRESS","MT_NAME","VEHI_NAME","EMERGENCY_PROCEDURES","REPAIR_ADDRESS","ACCESSORIES_USAGE","CHARGE_METHOD","IS_REPAIRED","IS_TRANSFER_ORDER","TRANSFER_ORDER_STATUS"};//导出map中的key
	...
	public String findshexcle(HttpServletRequest request,
			HttpServletResponse response,@RequestParam("postData") String postData) throws IOException{
		String a[] = {"报修日期","车牌号码","终端类型","终端子类型","业务区块","公司","故障类型","维修内容","维修地点","维修方式","维修人姓名","维修审核","审核人姓名","审核时间","维修费用","审核原因"};//导出列明
	...
	public String finddhexcle(HttpServletRequest request,
		...
		String a[] = {"报修日期","车牌号码","报修人员","联系电话","公司","故障类型","维修内容","维修地点","维修方式","维修人姓名","维修费用","回访结果","回访意见"};//导出列明
