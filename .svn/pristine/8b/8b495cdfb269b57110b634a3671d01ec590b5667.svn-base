...
//		String gzb = "维修车次";//导出sheet名和导出的文件名
	...
	@RequestMapping("/findpjgl")
	@ResponseBody
	public String findpjgl(HttpServletRequest request,@RequestParam("postData") String postData) {
		String msg = whServer.findpjgl(postData);
		return msg;
	}

	@RequestMapping("/addpjgl")
	@ResponseBody
	public String addpjgl(HttpServletRequest request,@RequestParam("postData") String postData){
		String msg = whServer.addpjgl(postData);
		return msg;
	}

	@RequestMapping("/updatepjgl")
	@ResponseBody
	public String updatepjgl(HttpServletRequest request,@RequestParam("postData") String postData){
		String msg = whServer.updatepjgl(postData);
		return msg;
	}

	@RequestMapping("/deletepjgl")
	@ResponseBody
	public String deletepjgl(HttpServletRequest request,@RequestParam("postData") String postData){
		String msg = whServer.deletepjgl(postData);
		return msg;
	}

	@RequestMapping("findpjglexcle")
	@ResponseBody
	public String findpjglexcle(HttpServletRequest request,
								HttpServletResponse response,@RequestParam("postData") String postData) throws IOException{
		String a[] = {"配件","价格"};//导出列明
		String b[] = {"PARTS_NAME","PARTS_PRICE"};//导出map中的key
		String gzb = "配件管理";//导出sheet名和导出的文件名
		postData = java.net.URLDecoder.decode(postData, "UTF-8");
		String msg = whServer.findpjgl(postData);
		List<Map<String, Object>>list = DownloadAct.parseJSON2List2(msg);
		DownloadAct.download(request,response,a,b,gzb,list);
