...
//		System.out.println(sql);
	...
	public String qxym(String power_info){
		String ym = "[{"+
					...
					if(power_info.indexOf("维修站收费情况月报")>=0){
						ym += "{id: \"sfHappen\", name: \"维修站收费情况月报\", icon: \"icon-wxjl\", src: \"./app/html/sfMonthlyReport.html\"},";
					}
					if(power_info.indexOf("月维修情况统计")>=0){
						ym += "{id: \"ywxHappen\", name: \"月维修情况统计\", icon: \"icon-wxjl\", src: \"./app/html/wxMonthlyStatistics.html\"},";
					}
			...
			if(power_info.indexOf("配件管理")>=0){
				ym += "{id: \"pjMaintain\", name: \"配件管理\", icon: \"icon-wxgl\", src: \"./app/html/pjMaintain.html\"},";
			}
