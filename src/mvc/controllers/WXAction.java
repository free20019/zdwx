...
public class WXAction {
	...
	public String findwxmxexcle(HttpServletRequest request,
			HttpServletResponse response,@RequestParam("postData") String postData) throws IOException{
		String a[] = {"送修时间","完修时间","车牌号码","终端类型","终端子类型","业务区块","公司","故障现象","维修内容","维修地点","维修类型","维修人姓名","维修审核","审核人姓名","审核时间","维修费用","审核原因"};//导出列明
		String b[] = {"SXSJ","WXSJ","VEHI_NO","MT_NAME","MDT_SUB_TYPE","OWNER_NAME","COMP_NAME","RM_MALFUNCTION","RC_CONTENT","RA_ADDR","RT_TYPE","WXRY","STATE","SHRY","SHSJ","RR_COST","NOTE"};//导出map中的key
