...
import mvc.service.CommonServer1;
 ...
 */
@Controller
@RequestMapping(value = "/common1")
public class CommonAction1 {
	private CommonServer1 commonService;

	public CommonServer1 getCommonServer() {
		return commonService;
	}

	@Autowired
	public void setCommonServer(CommonServer1 commonService) {
	...
	//内容
	@RequestMapping("/findnnr")
	@ResponseBody
	public String findnr(){
		String msg = commonService.findnr();
		return msg;
	}
	//公司
